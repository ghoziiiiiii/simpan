<?php
        include "koneksi.php";
        $no=1;
        $hasil = mysqli_query($koneksi, "SELECT * FROM data_perusahaan");
        $data = [];
    ...
    <body>
        <div class="d-flex" id="wrapper">
            ...
            <div id="page-content-wrapper">
                ...
                <!-- Page content-->
                <div class="container-fluid">
                    <h2 class="mt-4">Informasi Perusahaan Pelalawan</h2>
                    <div id="map"></div>
                </div>
            </div>
        </div>
