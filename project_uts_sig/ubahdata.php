<?php
    include "koneksi.php";
    $sql=mysqli_query($koneksi,"select * from data_perusahaan where id='$_GET[kode]'");
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td> <input type="text" name="jenis_perusahaan" value="<?php echo $data['jenis_perusahaan']; ?>"></td>
                        </tr>
                        <tr>
                ...
                <?php
                    ...
                    if(isset($_POST['proses'])){
                        mysqli_query($koneksi,"UPDATE data_perusahaan set
